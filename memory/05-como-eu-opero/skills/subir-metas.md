...
name: subir-metas
type: reference
description: SKILL subir-metas — importar as metas da equipe de planilha, doc ou print pro Auxiliator
...
- Garanta sessão logada (abra `auxiliator-deep`, passo 1) e **carregue [[api-do-auxiliator]]** (manual da `window.Aux` — você vai escrever no Auxiliator). Carregue [[modo-lideranca]] pro tom de líder.
