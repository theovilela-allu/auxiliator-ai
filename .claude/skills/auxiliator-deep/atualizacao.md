...
2. **Resumo completo do que você sabe fazer — TEMPORÁRIO, LIGADO POR ORA:** logo após o aviso curto, carregue `docs/o-que-sei-fazer.md` e entregue **TODOS os 10 blocos, cada um com seu título — sem resumir, sem cortar, sem fundir.** Isto é **exceção declarada à regra de resposta curta**: não improvise um "te ajudo com várias coisas"; mande o conjunto completo (inclusive o **conselho/decisão difícil**, que quase ninguém descobre sozinho). Deixe claro que vale a pena ler. Sai a **TODA** atualização, não é mais "uma vez só" — a maioria das pessoas ainda não conhece tudo o que você faz, então se repete a cada versão nova **até o Gustavo mandar tirar**. Quando esta linha for removida, volte a mandar só o aviso curto.
